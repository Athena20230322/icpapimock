...
namespace ICP.Batch.OPApiReSend.Repositories
{
    using Models;
    using Infrastructure.Core.Frameworks.DbUtil;
    using Infrastructure.Abstractions.DbUtil;

    public class OPApiReSendRepository
    {
        private readonly IDbConnectionPool _dbConnectionPool = null;

        public OPApiReSendRepository(IDbConnectionPool dbConnectionPool)
        {
        ...
        /// <returns></returns>
        [EnableDbProxy]
        public virtual List<BindOPAccountNotifyRecord> ListBindOPAccountNotify_ReSendRecord(byte Source, DateTime? DataDate = null)
        {
