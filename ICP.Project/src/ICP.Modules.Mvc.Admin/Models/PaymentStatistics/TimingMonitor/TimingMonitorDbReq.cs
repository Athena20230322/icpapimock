...
{
    public class TimingMonitorDbReq : PageModel
    {
        /// <summary>
        /// 查詢日期
        /// </summary>
        ...
        /// 1天交易監控比率
        /// </summary>
        public int Day1Waring { get; set; }

        /// <summary>
        /// 10天交易監控比率
        /// </summary>
        public int Day10Waring { get; set; }

        /// <summary>
        /// 30天交易監控比率
        /// </summary>
        public int Day30Waring { get; set; }        
        ...
        /// 1天最低交易總額
        /// </summary>
        public int Day1Amount { get; set; }

        /// <summary>
        /// 10天最低交易總額
        /// </summary>
        public int Day10Amount { get; set; }

        /// <summary>
        /// 30天最低交易總額
        /// </summary>
        public int Day30Amount { get; set; }
