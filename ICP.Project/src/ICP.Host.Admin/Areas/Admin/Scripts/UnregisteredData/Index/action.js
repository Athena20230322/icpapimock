...
(function () {
    ...
    $('#btnExport').click(function () {
        ...
        if (!startDate && !endDate && !cellPhone && !cName && !source) {
            libs.alert.popup('請先輸入查詢條件');
            return false;
        }

        location.href = '/UnregisteredData/Export?StartDate=' + startDate + '&EndDate=' + endDate + '&CellPhone' + cellPhone + '&CName' + cName + '&Source' + source
    });
